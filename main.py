...
def flux():
    ...
    prompt = data.get("prompt", "Crew Cut")
    hairColor = data.get("hairColor", "Black")
    ...
    try:
        output = replicate_client.run(
            ...
            input={"input_image": image, "haircut": prompt, "hair_color": hairColor, "gender":"male", "output_format": "jpeg"}
        )
